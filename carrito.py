...
pygame.display.set_caption('CUCHAU GAME')
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == KEYDOWN:
            ...
            # check collision when changing lanes
...
if gameover:
    ...
    font = pygame.font.Font(pygame.font.get_default_font(), 16)
    text = font.render('Game over. Play again? (Enter Y on N)', True, white)
    text_rect = text.get_rect()
...
#wait for users input to play again or exit
while gameover:
